...
$mail->Body = 'Bonjour, cliquer sur <a href="localhost/otf_food/include/verification.php?email='.$email.'&token='.$token.'">le lien de confirmation</a> pour valider votre inscription à notre application web.';
